...
class CustomVideoRenderer(
    ...
    override fun onFrame(frame: VideoFrame) {
        // Keep the WebRTC video pipeline alive even when TextureView temporarily
        // has no SurfaceTexture. Do not release or drop the frame here:
        // EglRenderer owns the frame after this call and is responsible for
        // dropping it when no render surface is available.
        if (!initialized) return
